...
function Workspace({ t, course, index, setIndex, lang, onDelete }) {
  ...
  <strong>
    {arabic ? 'تنبيه الذكاء الاصطناعي المسؤول' : 'Responsible AI Notice'}
  </strong>

  <p>
    {arabic
      ? 'تم إنشاء المحتوى بواسطة الذكاء الاصطناعي. يُنصح بمراجعة المعلومات الأكاديمية المهمة، وعدم رفع ملفات شخصية أو سرية.'
      : 'This content was generated by AI. Review important academic information and do not upload personal or confidential files.'}
  </p>
</div>
